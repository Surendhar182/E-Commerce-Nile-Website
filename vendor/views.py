...
def product_new(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            product.admin_profit = (product.vendor_price * Decimal(12))/ Decimal(100)  # calculate admin profit
            product.gst = (product.vendor_price * Decimal(5))/ Decimal(100)  # calculate GST
